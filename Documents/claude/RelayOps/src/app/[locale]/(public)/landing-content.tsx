...
export function LandingContent() {
  ...
  return (
    <MotionProvider>
      <div className="flex flex-col bg-[#FAFAFA] text-slate-900 font-sans" ref={containerRef}>
        
        {/* HERO SECTION */}
        <section className="relative overflow-hidden pt-28 pb-32 md:pt-40 md:pb-48">
          <m.div 
            style={{ y, opacity }}
            className="absolute top-0 left-1/2 w-full -translate-x-1/2 h-[500px] bg-hero-glow-animated pointer-events-none" 
          />
              ...
              <FadeIn>
                ...
                <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
                  <Button
                    asChild
                    size="lg"
                    className="h-12 w-full rounded-full bg-blue-600 px-8 text-[15px] font-medium text-white shadow-[0_8px_16px_rgb(59,130,246,0.2)] transition-all duration-300 hover:-translate-y-1 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-500 hover:shadow-[0_12px_24px_rgb(59,130,246,0.3)] sm:w-auto"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="h-11 w-full rounded-full border-slate-200/80 bg-white px-6 text-[15px] font-medium text-slate-600 shadow-[0_2px_8px_rgb(0,0,0,0.04)] transition-all duration-300 hover:-translate-y-1 hover:bg-slate-50 hover:shadow-[0_8px_16px_rgb(0,0,0,0.06)] sm:w-auto"
                  >
              ...
              {valueProps.map((item, index) => {
                ...
                return (
                  <StaggerItem
                    key={item.title}
                    className={cn(
                      'group rounded-[24px] bg-[#FAFAFA] p-8 transition-all duration-300 hover:scale-[1.02] hover:bg-white hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] hover:border-blue-500/30 border border-transparent',
                      item.highlight ? 'md:col-span-2' : 'md:col-span-1'
                    )}
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white shadow-[0_2px_8px_rgb(0,0,0,0.04)] text-blue-600 transition-colors group-hover:bg-blue-50 group-hover:text-blue-700">
                ...
                {workflowSteps.map((item) => {
                  return (
                    <StaggerItem
                      key={item.title}
                      className={cn(
                        "group flex flex-col sm:flex-row sm:items-start gap-6 rounded-[24px] border border-slate-200/50 bg-white p-8 transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] hover:border-blue-500/30",
                        item.highlight ? "ring-1 ring-blue-500/20 shadow-sm" : ""
                      )}
                    >
                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-slate-50 text-slate-900 transition-colors group-hover:bg-blue-50 group-hover:text-blue-600">
        ...
        <section className="bg-white py-32 border-t border-slate-100">
          <div className="container max-w-7xl text-center">
            ...
            <SlideUp transition={{ delay: 0.3 }} className="mx-auto mt-24 max-w-4xl">
              <div className="rounded-[32px] bg-[#FAFAFA] p-10 md:p-16 text-left transition-all duration-300 hover:shadow-[0_16px_40px_rgb(0,0,0,0.06)] hover:border hover:border-blue-100 hover:bg-white border border-transparent">
            ...
            <FadeIn className="rounded-[32px] bg-slate-900 p-12 text-center text-white shadow-[0_32px_64px_-16px_rgb(0,0,0,0.2)] md:p-20">
              ...
              <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="h-14 rounded-full border-slate-700 bg-slate-800 px-8 text-[15px] font-medium text-white transition-all duration-300 hover:-translate-y-1 hover:bg-slate-700 hover:shadow-[0_8px_16px_rgb(0,0,0,0.2)]"
                >
