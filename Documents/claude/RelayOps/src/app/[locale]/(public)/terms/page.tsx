...
import { MotionProvider, FadeIn } from '@/components/ui/motion'
        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <FadeIn>
            <div className="space-y-2 mb-10">
              ...
              <h1 className="font-display text-4xl font-bold tracking-[-0.06em] text-slate-900">Terms of Service</h1>
            ...
            <div className="prose prose-slate max-w-none space-y-8 text-sm text-slate-700 leading-relaxed">
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  to the published{' '}
                  <Link href="/security" className="text-blue-600 hover:underline font-medium">
                    retention schedule
                  </Link>
                  .
                </p>
