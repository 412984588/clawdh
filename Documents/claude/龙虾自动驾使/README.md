...
[![CI](https://github.com/zhimingdeng/lobster-perpetual-engine/actions/workflows/ci.yml/badge.svg)](https://github.com/zhimingdeng/lobster-perpetual-engine/actions/workflows/ci.yml)
...
cp -r lobster-perpetual-engine ~/.openclaw/workspace/plugins/
