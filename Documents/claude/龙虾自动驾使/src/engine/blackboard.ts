...
export class Blackboard {
  ...
  private eventListeners: Map<string, Set<(event: BlackboardEvent) => void>> = new Map();
   ...
   * 查询数据
   */
  query(options: QueryOptions): Array<{ key: string; value: any; entry: BlackboardEntry }> {
   ...
   * 订阅键变化
   */
  subscribe(key: string, callback: (value: any, entry: BlackboardEntry) => void): () => void {
