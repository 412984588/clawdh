...
source: wechat
url: https://mp.weixin.qq.com/s/S0HGdZa8nIwwJlK2Oje1yA
author: 数据之书
pub_date: 2025年11月4日 01:33
...
> 作者: 数据之书 | 发布日期: 2025年11月4日 01:33
> 原文链接: [点击查看](https://mp.weixin.qq.com/s/S0HGdZa8nIwwJlK2Oje1yA)
...
如果我想做一个略微复杂一些的Web项目（基于Python的FastAPI框架），大致结构可以如下：
...
架构定义语言（**Architecture Definition Language, ADL**）：对于更复杂的系统，可以考虑使用轻量级的 ADL 来描述你的架构。这种方式可以用伪代码的形式定义系统的结构和约束，然后将 ADL 作为提示提供给 AI，让它生成符合架构定义的代码。
4. 总结
