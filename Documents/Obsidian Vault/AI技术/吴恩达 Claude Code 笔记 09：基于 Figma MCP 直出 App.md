# 吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App

## 基本信息
- **标题**: 吴恩达 Claude Code 笔记 09：基于 Figma MCP 直出 App
- **来源**: 微信公众号
- **作者**: 南川同学
- **发布时间**: 2025年08月23日
- **URL**: https://mp.weixin.qq.com/s/lm4vYa0mzEc4Yc6w736OtA
- **分类**: AI技术
...
经历了前面八期的学习和实践，我们已经从基础的代码理解、功能开发，一路走到了测试驱动调试、并行开发、乃至云端 GitHub 流程自动化。我们手中的 Claude Code，其形象也...
...
感谢 Elie Schoppik 老师的精彩讲解，也感谢各位读者的一路相伴。虽然课程解读到此结束，但 AI 辅助开发的探索之旅，才刚刚开始。在接下来的文章中，我将脱离课程本身，分享我的 Claude Code 个人最佳实践，以及本系列教程AI搬运工作流，敬请期待!
...
https://github.com/https-deeplearning-ai/FRED-dashboard[1]
...
https://github.com/https-deeplearning-ai/sc-claude-code-files[2]

DeepLearning.AI 课程主页 (DeepLearning.AI Course Homepage):

观看原版视频课程，体验 Elie Schoppik 老师的亲自教学。
https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant[3]
关键指令与 Prompt
1. 项目初始化
...
注意：执行此 Prompt 前，请先前往 FRED 官网[4] 申请你自己的 API Key。
Figma MCP 备选方案
...
[1] https://github.com/https-deeplearning-ai/FRED-dashboard, https://github.com/https-deeplearning-ai/FRED-dashboard

[2] https://github.com/https-deeplearning-ai/sc-claude-code-files, https://github.com/https-deeplearning-ai/sc-claude-code-files

[3] https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant, https://learn.deeplearning.ai/courses/claude-code-a-highly-agentic-coding-assistant

[4] FRED 官网, https://fred.stlouisfed.org/docs/api/api_key.html
