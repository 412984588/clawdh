"""Tests for job-search-toolkit bundle."""
import json
...
TEMPLATE_IDS = [
    ...
    "06-linkedin-optimization",
    "07-portfolio-builder",
    "08-networking-scripts",
    "09-follow-up-emails",
    "10-90day-onboarding",
]

CONTENT_KEYWORDS = ["resume", "job", "interview", "salary", "hire", "career", "role", "company", "offer", "skill"]
